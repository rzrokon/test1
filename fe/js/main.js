...
function openChat() {
    if (isChatOpen === false) {
        ...
        document.getElementById("js-close-landing").classList.remove("d-none");
    }
}
...
document.getElementById("js-get-services").addEventListener("click", function (event) {
    event.preventDefault();
    isChatOpen = false;

    document.getElementById("js-msg-head").classList.add("d-none");
    document.getElementById("js-msg-body").classList.add("d-none");
    document.getElementById("js-landing").classList.remove("d-none");
});

document.getElementById("js-close-landing").addEventListener("click", function (event) {
    event.preventDefault();
    openChat();
});
